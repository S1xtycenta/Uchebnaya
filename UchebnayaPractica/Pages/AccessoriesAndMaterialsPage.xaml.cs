...
namespace UchebnayaPractica.Pages
{
    ...
    public partial class AccessoriesAndMaterialsPage : Page
    {
        ...
        {
            NavigationService.Navigate(new AddEditMaterialPage((sender as Button).DataContext as Material));
        }

        private void EditA_Click(object sender, RoutedEventArgs e)
        {
            NavigationService.Navigate(new AddEditAccessoriesPage((sender as Button).DataContext as Accessories));
        }

        private void DeleteA_Click(object sender, RoutedEventArgs e)
        {
            Accessories accessories = (sender as Button).DataContext as Accessories;
