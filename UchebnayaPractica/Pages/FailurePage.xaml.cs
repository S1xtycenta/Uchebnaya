...
namespace UchebnayaPractica.Pages
{
    ...
    public partial class FailurePage : Page
    {
        ...
        {
            NavigationService.Navigate(new AddEditFailure((sender as Button).DataContext as HardwareFailure, this));
        }
        ...
        private void Delete_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                App.db.HardwareFailure.Remove((sender as Button).DataContext as HardwareFailure);
                Refresh();
