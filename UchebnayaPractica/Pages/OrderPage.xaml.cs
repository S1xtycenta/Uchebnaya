...
namespace UchebnayaPractica.Pages
{
    ...
    public partial class OrderPage : Page
    {
        ...
        {
            NavigationService.Navigate(new AddEditOrder((sender as Button).DataContext as Order, false, this, "Редактировать заказ"));
        }
        ...
        private void Delete_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                App.db.Order.Remove((sender as Button).DataContext as Order);
